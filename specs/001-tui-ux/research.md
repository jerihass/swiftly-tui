...
- Current gaps: SwifTeaUI already provides Border, theme colors, toasts, and modals. If richer progress/error widgets are needed later, document them for the SwifTeaUI team (no custom ASCII fallbacks).
